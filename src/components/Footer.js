            ...
            <div className="col-4">
              ...
              <div>
                <address className="text-white fs-6">
                  Ngong Lane Plaza, <br /> Ngong rd, Nairobi <br />
                  Kenya
                </address>
                <a
                ...
                <div className="social_icons d-flex align-items-center gap-30 mt-4">
                  <a className="text-white" href="https://linkedin.com/in/salvato-luis">
                    <BsLinkedin className="fs-4" />
                  </a>
                  <a className="text-white" href="https://instagram.com/salvato_luiz">
